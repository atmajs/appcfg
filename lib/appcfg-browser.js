...
function obj_interpolate(obj, root, isOptional) {
    ...
    obj_visitStrings(obj, function (str, key, parent) {
        str = str.trim();
        var c0 = str.charCodeAt(0), c1 = str.charCodeAt(1), has = false;
        if (c0 === 35 && c1 === 91) {
            // #[
...
//# sourceMappingURL=LocalStorageSource.ts.map;
    ...
    if (isObject(_src_sources_LocalStorageSource) && isObject(module.exports)) {
...
function getSpecialFolder(name) {
    ...
    switch (name) {
        ...
        case 'APP':
            ...
            path = atma_io_1.env.currentDir.toLocalDir();
            break;
        case 'APPDATA':
            path = nodeEnv.HOME;
            break;
...
SourceFactory_1.SourceFactory.register('query', {
    canHandle: function (data) {
        return typeof (data === null || data === void 0 ? void 0 : data.query) != null;
    },
    create: function (data) {
...
var QuerySourceSource = /** @class */ (function () {
    ...
    QuerySourceSource.prototype.readSync = function () {
        try {
            this.config = path_1.path_getQuery(location.search);
        }
        catch (error) {
        }
        return this;
...
//# sourceMappingURL=QuerySource.ts.map;
    ...
    if (isObject(_src_sources_QuerySource) && isObject(module.exports)) {
...
//# sourceMappingURL=exports-browser.ts.map;
    ...
    if (isObject(_src_sources_exports_browser) && isObject(module.exports)) {
...
var _cfg, _params, _refs, _refCount;
...
//# sourceMappingURL=ConfigBrowser.ts.map;
    ...
    if (isObject(_src_ConfigBrowser) && isObject(module.exports)) {
