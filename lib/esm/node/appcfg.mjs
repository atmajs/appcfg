...
function obj_deepExtend(target, source, opts) {
    ...
    for (let key in source) {
        ...
        if ((0, atma_utils_1.is_Array)(val)) {
            const extendArrays = (opts === null || opts === void 0 ? void 0 : opts.extendArrays) !== false;
            const idKey = (_a = opts === null || opts === void 0 ? void 0 : opts.mergeArrayItems) === null || _a === void 0 ? void 0 : _a[key];
...
function mergeArrays(targetArr, sourceArr, idKey) {
    ...
    for (let i = 0; i < targetArr.length; i++) {
        ...
        if (source != null) {
            targetArr[i] = Object.assign(Object.assign({}, target), source);
        }
    }
...
function getValue(property, obj, isOptional) {
    ...
    if (typeof process !== 'undefined' && process.env != null) {
        let val = (0, atma_utils_1.obj_getProperty)(process.env, property);
        if (val != null) {
            return val;
        }
    }
    let val = (0, atma_utils_1.obj_getProperty)(obj, property);
    if (val != null) {
        return val;
    }
    if (!isOptional) {
...
(function (yaml) {
    ...
    (function (parser) {
        ...
        function unwrapFlow(value, open, close, line) {
            ...
            if (value.charAt(0) !== open || value.charAt(value.length - 1) !== close)
                throw new YamlError(`Expected ${open}${close} flow value`, line);
        ...
        function splitFlow(value, delimiter) {
            let parts = [], start = 0, quote = '', depth = 0;
    ...
    let serializer;
    (function (serializer) {
        function serialize(mix, indent = 0) {
...
function prepareFile(file, method) {
    ...
    if (file.uri.extension === 'yml') {
        ...
        let handler = atma_io_1.File.getHookHandler();
...
SourceFactory_1.SourceFactory.register('directory', {
    ...
    create(data) {
        ...
        let files = dir
            ...
            return Object.assign(Object.assign({}, data), { path });
        });
