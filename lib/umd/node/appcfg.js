...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_util_yamlV0 != null ? _src_util_yamlV0 : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_util_yamlV0 === module.exports) {
        // do nothing if
    } else if (__isObj(_src_util_yamlV0) && __isObj(module.exports)) {
        Object.assign(_src_util_yamlV0, module.exports);
    } else {
        _src_util_yamlV0 = module.exports;
    }
            ...
            handler.register('yml', 'read', {
                ...
                read: function (file, config) {
                    ...
                    if (typeof content === 'string') {
                        file.content = yamlV0_1.yaml.parse(content);
                    }
                }
            });
            handler.register('yml', 'write', {
                ...
                write: function (file, config) {
                    ...
                    if (content != null && typeof content === 'object') {
                        file.content = yamlV0_1.yaml.serialize(content);
                    }
                }
            });
        }
