...
function obj_deepExtend(target, source, opts) {
    ...
    for (var key in source) {
        ...
        if ((0, atma_utils_1.is_Array)(val)) {
            ...
            if (extendArrays || (opts === null || opts === void 0 ? void 0 : opts.mergeArrayItems) != null) {
                ...
                if ((opts === null || opts === void 0 ? void 0 : opts.mergeArrayItems) != null) {
                    var idKey = opts.mergeArrayItems[key];
