...
function cfg_merge(target, config, setterProperty) {
    ...
    (0, object_1.obj_deepExtend)(target, config);
}
...
var Sources = /** @class */ (function () {
    ...
    Sources.prototype.loadSync = function (rootConfig) {
        ...
        while (++i < imax) {
            ...
            (0, cfg_1.cfg_merge)(rootConfig, source.config, source.data.setterProperty);
            if (after) {
...
function file_readSourceAsync(rootConfig, path, data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    file = resolveFile(path, data);
                    if (file == null) {
                        throw new Error("".concat(path, " file not found"));
                    }
...
function file_readSourceSync(rootConfig, path, data) {
    var file = resolveFile(path, data);
    if (file == null) {
        return null;
    }
...
;
function resolveFile(path, data, checkExists) {
    ...
    if (checkExists === false || atma_io_1.File.exists(uri.toString())) {
